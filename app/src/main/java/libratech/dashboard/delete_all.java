...
public class delete_all extends javax.swing.JPanel {
    ...
    private DatabaseReference book = FirebaseDatabase.getInstance().getReference("books/" + new getUID().getUid());
    ...
    private void initComponents() {
        ...
        confirmlabel.setText("Delete All Books");
        ...
        txt.setText("Deleting all books will permanently remove them from your library. This action cannot be undone. Are you sure you want to proceed?");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(confirmlabel, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitActionPerformed
        // TODO add your handling code here:
        //GlassPanePopup.closePopupLast();
        book.getRef().removeValue(completionListener);
        home home = new home();
        ...
        JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(delete_all.this);
        frame.dispose();
